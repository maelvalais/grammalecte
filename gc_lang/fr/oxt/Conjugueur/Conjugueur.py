...
class Conjugueur (unohelper.Base, XActionListener, XJobExecutor):
    ...
    def run (self, sArgs=""):
        ...
        # grid
        nX1 = 10; nX2 = nX1+123;
        nY0 = 2; nY1 = nY0+28; nY2 = nY1-4; nY3 = nY1+15; nY4 = nY3+49; nY5 = nY4+53; nY6 = nY5+53; nY7 = nY6+53; nY6b = nY6+20; nY7b = nY6b+53

        # group box // indicatif
        gb_infi = self._addWidget('groupbox_infi', 'GroupBox', nX1-5, nY0, nGroupBoxWith, 25, Label = "Infinitif", \
                                  FontDescriptor = xFDmode, FontRelief = 1, TextColor = nColorHead)
        self.infi = self._addWidget('infi', 'FixedText', nX1, nY0+12, nWidth, nHeight, Label = "", FontDescriptor = xFDbold)
