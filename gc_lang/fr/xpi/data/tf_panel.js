...
function reset () {
    for (xNode of document.getElementsByClassName("option")) {
...
function applyOptions (sText) {
    try {
        ...
        resetProgressBar();
        document.getElementById('progressbar').max = 28;
        ...
        document.getElementById('progressbar').value = 24;
        ...
        const t1 = Date.now();
        document.getElementById('time_res').textContent = ((t1-t0)/1000).toString() + "s";
    }
    catch (e) {
        console.error("\n" + e.fileName + "\n" + e.name + "\nline: " + e.lineNumber + "\n" + e.message);
    }
