...
lang = u"fr"
locales = {'fr-SN': ['fr', 'SN', ''], 'fr-BJ': ['fr', 'BJ', ''], 'fr-LU': ['fr', 'LU', ''], 'fr-NE': ['fr', 'NE', ''], 'fr-MC': ['fr', 'MC', ''], 'fr-ML': ['fr', 'ML', ''], 'fr-CI': ['fr', 'CI', ''], 'fr-TG': ['fr', 'TG', ''], 'fr-CH': ['fr', 'CH', ''], 'fr-CA': ['fr', 'CA', ''], 'fr-BE': ['fr', 'BE', ''], 'fr-FR': ['fr', 'FR', ''], 'fr-BF': ['fr', 'BF', '']}
pkg = u"grammalecte"
name = u"Grammalecte"
version = u"0.5.8"
author = u"Olivier R."
